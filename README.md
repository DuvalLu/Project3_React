...
3. Additional pages that all have their own respective type of tasks. Vanquish the Sith, Padawan training, Star Wars history quiz, etc.

# USER STORIES:

## As a Jedi

1. I want to see a list of all active Sith, so that I know which enemies remain.
2. I want to mark a Sith as vanquished/show the Jedi that defeated him to track my progress.
3. I want delete Sith from the list entirely, so that I can keep my list clean.
